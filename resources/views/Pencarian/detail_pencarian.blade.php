            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div style="background-color: #6259ca;
                        ...
                        <img src="{{ asset('storage/logo/LOGO_PST.png') }}" alt="Logo" style="width: 200px;
                            height: auto;
                            position: absolute;
                            top: 50%;
                            left: 20px;
                    ...
                    <div style="display: flex; align-items: flex-start; margin-top: 30px;">
                        <iframe id="pdf-viewer" src="{{ asset('/laraview/#../storage/' . $dokumen->lampiran) }}"
                            alt="Lampiran dokumen"
                            style="width: 600px; height: 600px; border: 1px solid #ddd; margin-right: 20px;"
                    ...
                    <div style="margin-top: 20px;">
                        <a href="{{ route('pencarian') }}"
                            style="padding: 10px 20px; background-color: #333; color: white; border: none; border-radius: 5px; cursor: pointer; margin-right: 10px;">KEMBALI
                            KE SEBELUMNYA
                        </a>
                    </div>
                </div>
    ...
    <div class="d-flex flex-row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control text-black" id="penerima" value="{{ $dokumen->penerima }}"
                    readonly>
            </div>
            <div class="form-group">
                <label for="pengirim" class="form-label">Pengirim Surat</label>
                <input type="text" class="form-control text-black" id="pengirim" value="{{ $dokumen->pengirim }}"
                    readonly>
            </div>
            @if ($dokumen->persetujuan)
            <div class="form-group">
                <label for="persetujuan" class="form-label">Persetujuan</label>
                <input type="text" class="form-control text-black" id="persetujuan" value="{{ $dokumen->persetujuan }}"
                    readonly>
            </div>
            @endif
            @if ($dokumen->status)
            <div class="form-group">
                ...
                <input type="text" class="form-control text-black" id="status" value="{{ $dokumen->status }}" readonly>
            </div>
            @endif
        ...
        <div class="col-6">
            <iframe id="pdf-viewer" src="{{ asset('/laraview/#../storage/' . $dokumen->lampiran) }}" width="100%"
                height="500px" style="border: none;" allowfullscreen webkitallowfullscreen></iframe>
        </div>
    </div>
</div>
</div> --}}
